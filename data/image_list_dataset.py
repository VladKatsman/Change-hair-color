...
def calc_weights_for_balanced_classes(samples):
...
class ImageListDataset(DatasetFolder):
    """A generic data loader where the images are arranged in this way: ::
        ...
        root/Images/dog/xxx.jpg
        root/Images/dog/xxy.jpg
        root/Images/dog/xxz.jpg

        root/Images/cat/123.jpg
        root/Images/cat/nsdf3.jpg
        root/Images/cat/asd932.jpg
    ...
    def __init__(self, root, img_list, transform=None, target_transform=None, loader=default_loader):
        ...
        self.weights = calc_weights_for_balanced_classes(self.samples)
