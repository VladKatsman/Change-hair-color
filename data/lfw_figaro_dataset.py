...
class LF(data.Dataset):
    """Data loader for Labeled Faces in the Wild dataset.
    ...
    def __init__(
        ...
        file_list = [id_.rstrip() for id_ in file_list]
        self.segs = file_list
        # weights for balanced sampling between datasets
        # 2.642 images from lfw for 1 image of figaro, 2485 is the last index of lfw data
        self.weights = [1 / 2.8 if i < 2926 else 1 for i in range(len(self.images))]  # 2.642 and 2486 for train/val split
