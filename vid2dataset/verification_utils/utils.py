...
from verification_utils.evaluation import evaluate
...
def perform_val(device, model_path, embedding_size, batch_size, carray, issame, nrof_folds = 10, tta = True):
...
def lfw_val(data_path, model_path, dataset):
    lfw, lfw_issame = get_val_pair(data_path, dataset)
    accuracy, best_thresholds, roc_curve_tensor = perform_val(
        0, model_path, 512, 512, lfw, lfw_issame, nrof_folds=10, tta=True
    )
    print(accuracy, best_thresholds)


if __name__ == "__main__":

    lfw_val("/home/noteme/Desktop/lfw_align_112", "/data/dev/models/backbone_ir50_ms1m_epoch63.pth", "lfw")
    lfw_val("/home/noteme/Desktop/VGGFace2_FP", "/data/dev/models/backbone_ir50_ms1m_epoch63.pth", "vgg2_fp")